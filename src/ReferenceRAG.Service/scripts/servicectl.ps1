<#
.SYNOPSIS
    Control ReferenceRAG Windows Service
.DESCRIPTION
    Start, stop, restart, or check status of the ReferenceRAG service.
.PARAMETER Action
    ...
    "status" {
        ...
        if ($service.Status -eq "Running") {
            ...
            $proc = Get-Process -Name "dotnet" -ErrorAction SilentlyContinue | Where-Object {
                $_.CommandLine -like "*ReferenceRAG*" -or $_.Path -like "*ReferenceRAG*"
